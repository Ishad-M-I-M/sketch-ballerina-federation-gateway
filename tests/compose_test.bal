...
// function compose(json finalResult, json resultToCompose, string[] path) returns json|error {
//     string[] pathCopy = path.clone();
//     json pointer = finalResult.clone();
...
//                     results.push(check compose(pointer[i], resultToCompose[i], pathCopy));
//                 }
//                 return results;
//             }
//         }
...
//     json|error result = compose(test1, test1a, ["missions"]);
//     if result is error {
//         test:assertFail(msg = result.message());
//     }
//     else {
//         test:assertEquals(result, test1Result);
//     }
...
//     json|error result = compose(test2, test2a, ["@", "missions"]);
//     if result is error {
//         test:assertFail(msg = result.message());
//     }
//     else {
//         test:assertEquals(result, test2Result);
//     }
...
//     json|error result = compose(test3, test3a, ["missions", "@", "crew", "@", "name"]);
//     if result is error {
//         test:assertFail(msg = result.message());
//     }
//     else {
//         test:assertEquals(result, test3Result);
//     }
...
//     json|error result = compose(test4, test4a, ["@", "missions", "@", "crew", "@", "name"]);
//     if result is error {
//         test:assertFail(msg = result.message());
//     }
//     else {
